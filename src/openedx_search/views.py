"""
Views for the openedx_search app.
"""
...
from openedx_search.models import CourseArchiveStatus
from openedx_search.serializers import CourseArchiveStatusSerializer
